...
public class ThemThanhVienController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        this.hoKhau = ThongTinHoKhauController.hoKhauBean;
        setData();
        thanhVienMoi = new ArrayList();
    ...
    public void confirm(ActionEvent e) throws IOException, ClassNotFoundException, SQLException {
        ...
        hoKhauService.addNewThanhVien(hoKhau, thanhVienMoi);
        if (thanhVienMoi.size() == 0) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Thông báo");
            alert.setHeaderText("Vui lòng chọn thành viên cần thêm!");
            alert.show();
        } else {
